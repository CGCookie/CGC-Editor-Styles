<?php
/*
Plugin Name: CGC Editor Styles
Plugin URI: http://cgcookie.com
Description: Adds custom styles to the WYSIWYG editor
...
function themeit_tiny_mce_before_init( $settings )
{
	...
	$style_formats = array(
		...
		array( 'title' => 'Editor Note',        'block'    => 'div',  'classes' => 'editor-note' ),
		array( 'title' => 'Message',        'block'    => 'div',  'classes' => 'custom-message' ),

		array( 'title' => 'Lists' ),		
		array( 'title' => 'List - Check',          'selector'   => 'ul', 'classes' => 'styled-list styled-list-check' ),
		array( 'title' => 'List - Plus',          'selector'   => 'ul', 'classes' => 'styled-list styled-list-plus' ),

		array( 'title' => 'Pull Content' ),

		array( 'title' => 'Pull Content - Left',        'block'    => 'div',  'classes' => 'pull-content pull-left' ),
		array( 'title' => 'Pull Content - Right',        'block'    => 'div',  'classes' => 'pull-content pull-right' ),
		array( 'title' => 'Pull Quote - Left',        'selector'    => 'blockquote',  'classes' => 'pull-quote pull-content pull-left' ),
		array( 'title' => 'Pull Quote - Right',        'selector'    => 'blockquote',  'classes' => 'pull-quote pull-content pull-right' ),
		
		array( 'title' => 'Buttons' ),
		array( 'title' => 'Button',		'selector' => 'a',  'classes' => 'button' ),
		array( 'title' => 'Button - Gray',		'selector' => 'a',  'classes' => 'button button-gray' )		
	);
